...
class _RegisterState extends State<Register> with TickerProviderStateMixin {
      ...
      children: [
        Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: error != null ? Colors.red.withValues(alpha: 0.6) : border,
              width: 1.2,
            ),
          ),
          child: TextField(
          ...
          children: List.generate(
            ...
            (i) => Expanded(
              child: Container(
                ...
                height: 4,
                decoration: BoxDecoration(
                  color: i < _passwordStrength ? _strengthColor() : border,
  ...
  Widget _buildRulesSection() {
    return Container(
      decoration: BoxDecoration(
        color: const Color.fromARGB(255, 143, 35, 134),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: const Color.fromARGB(255, 55, 36, 56),
          width: 1.2,
        ),
      ),
      child: Column(
          ...
          AnimatedCrossFade(
            ...
            secondChild: Padding(
              ...
              child: Column(
                children: [
                  const Divider(
                    color: Color.fromARGB(255, 205, 85, 191),
                    height: 1,
                  ),
                  const SizedBox(height: 14),
                  ..._rules.map(
      ...
      children: [
        GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: _agreedToTerms ? accent : Colors.transparent,
              borderRadius: BorderRadius.circular(6),
              border: Border.all(
                color: _agreedToTerms ? accent : border,
                width: 1.5,
              ),
            ),
